...
--
INSERT INTO Roles(Name) VALUES ('Employee'),('Employer');
--
-- Dumping data for table `JobFields`
--
INSERT INTO JobFields(Name) VALUES 
('Accounting / Finance'),('Administration'),('Analyst / Research'),('Banking'),
('Business Development'),('GM / Director'),('Designing / Art'),('Customer Service / Support'),
('Education / Teaching'),('Engineering'),('Fashion'),('Hospitality / Services'),
('Human Resources'),('Installation / Maintenance'),('IT / Software Development'),('Legal'),
('Logistics / Supply Chain'),('Manufacturing / Production'),('Marketing / PR / Advertising'),('Media / Jounalism / Publishing'),
('Medical / Healthcare'),('Operations / Management'),('Pharmaceutical'),('Project / Program Management'),
('Purchasing / Procurement'),('Quality'),('R&D / Sience'),('Sales / Retail'),
('Sports and Leisure'),('Strategy / Consulting'),('Tourism / Travel'),('Training / Instructor'),('Writing / Editorial'),('Other');
